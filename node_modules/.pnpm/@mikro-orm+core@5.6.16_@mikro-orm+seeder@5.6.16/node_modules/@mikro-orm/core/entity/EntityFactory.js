...
class EntityFactory {
    ...
    mergeData(meta, entity, data, options = {}) {
        ...
        Object.keys(data).filter(key => [enums_1.ReferenceType.ONE_TO_MANY, enums_1.ReferenceType.MANY_TO_MANY].includes(meta.properties[key]?.reference)).forEach(key => diff2[key] = data[key]);
