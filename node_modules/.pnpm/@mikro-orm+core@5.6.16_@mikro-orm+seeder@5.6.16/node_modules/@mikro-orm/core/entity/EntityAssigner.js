...
class EntityAssigner {
    ...
    static assignProperty(entity, propName, props, data, options) {
        ...
        if (prop && Utils_1.Utils.isCollection(entity[propName])) {
            return EntityAssigner.assignCollection(entity, entity[propName], value, prop, options.em, options);
        }
        ...
        if (prop?.reference === enums_1.ReferenceType.SCALAR && enums_1.SCALAR_TYPES.includes(prop.type) && (prop.setter || !prop.getter)) {
            return entity[propName] = validator.validateProperty(prop, value, entity);
        }
